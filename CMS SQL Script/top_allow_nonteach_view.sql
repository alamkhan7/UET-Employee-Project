...
sum(net.Gross_pay)
from allowance allow, employee emp, employee_non_teaching empnonteach, section sec, campus camp, netsalary net
where emp.employee_code=empnonteach.employee_code AND allow.employee_code=emp.employee_code and empnonteach.section_id=sec.section_id
