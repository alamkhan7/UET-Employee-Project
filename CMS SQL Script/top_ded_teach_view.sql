...
sum(net.Net_Salary)
from deduction Ded, employee emp, employee_teaching empteach, department dept, campus camp, netsalary net
where emp.employee_code=empteach.employee_code AND Ded.employee_code=emp.employee_code and empteach.department_id=dept.department_id
