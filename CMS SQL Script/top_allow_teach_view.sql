...
sum(net.Gross_pay)
from allowance allow, employee emp, employee_teaching empteach, department dept, campus camp, netsalary net
where emp.employee_code=empteach.employee_code AND allow.employee_code=emp.employee_code and empteach.department_id=dept.department_id
